...
class _UserApiClient implements UserApiClient {
  ...
  Future<UserStatsModel> getUserStats() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserStatsModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/users/me/stats',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UserStatsModel _value;
    try {
      _value = UserStatsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<UserResponse> updateProfile(Map<String, dynamic> userData) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<List<UserResponse>> getAllUsers({int? page, int? limit}) async {
    final _extra = <String, dynamic>{};
